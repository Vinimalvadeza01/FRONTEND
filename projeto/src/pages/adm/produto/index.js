...
export default function PageProdutoAdm(){
    ...
    // Para selecionar quais imagens serão deletadas
    const[excluirSec1,setExcluirSec1]=useState(false);
    const[excluirSec2,setExcluirSec2]=useState(false);
    const[excluirSec3,setExcluirSec3]=useState(false);
    const[excluirSec4,setExcluirSec4]=useState(false);
    ...
    async function deletarImageSec(){
            ...
            <div className='container-page'>
                ...
                <div className='container-imagens'>
                    ...
                    <div className='imagens-secundarias'>
                        ...
                        {imageSecAlteracao || imageSecDeletar ?
                            imageSecAlteracao ? 
                                ...
                                :                             
                                    <div className='container-labels-excluirSec'>
                        ...
                        <div className='div-buttons'>
                            ...
                            {imageSecDeletar ? 
                                <div className='buttons-deletar-images-sec'>
                                    <button className='button1' onClick={deletarImageSec}>Deletar essas imagens</button>
                ...
                <div className='container-infs'>
                    ...
                    <form className='infs'>
                        ...
                        <div> 
                            ...
                            {produtoEmAlteracao ? '' : 
                                <input type='button' value={infsProduto.Disponível ? 'Deixar indisponível' : 'Deixar disponível'} onClick={() =>{
                                    const hoje=new Date();
